...
class HistoryApi {
  ...
  */
  ...
  getHistoricalCandleData(instrumentKey, interval, toDate, apiVersion, callback) {
    ...
    return this.apiClient.callApi('/historical-candle/{instrumentKey}/{interval}/{to_date}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getHistoricalCandleData1(instrumentKey, interval, toDate, fromDate, apiVersion, callback) {
    ...
    let accepts = ['application/json', '*/*'];
    let returnType = _GetHistoricalCandleResponse.GetHistoricalCandleResponse;
    return this.apiClient.callApi('/historical-candle/{instrumentKey}/{interval}/{to_date}/{from_date}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getIntraDayCandleData(instrumentKey, interval, apiVersion, callback) {
    ...
    return this.apiClient.callApi('/historical-candle/intraday/{instrumentKey}/{interval}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
