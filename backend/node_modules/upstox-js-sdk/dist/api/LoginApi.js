...
class LoginApi {
  ...
  */
  ...
  authorize(clientId, redirectUri, apiVersion, opts, callback) {
    ...
    let returnType = null;
    return this.apiClient.callApi('/login/authorization/dialog', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  logout(apiVersion, callback) {
    ...
    return this.apiClient.callApi('/logout', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  token(apiVersion, opts, callback) {
    ...
    return this.apiClient.callApi('/login/authorization/token', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
