...
class OrderApi {
  ...
  */
  ...
  cancelOrder(orderId, apiVersion, callback) {
    ...
    return this.apiClient.callApi('/order/cancel', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getOrderBook(apiVersion, callback) {
    ...
    return this.apiClient.callApi('/order/retrieve-all', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getOrderDetails(apiVersion, opts, callback) {
    ...
    return this.apiClient.callApi('/order/history', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getTradeHistory(apiVersion, callback) {
    ...
    return this.apiClient.callApi('/order/trades/get-trades-for-day', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getTradesByOrder(orderId, apiVersion, callback) {
    ...
    let accepts = ['application/json', '*/*'];
    let returnType = _GetTradeResponse.GetTradeResponse;
    return this.apiClient.callApi('/order/trades', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  modifyOrder(body, apiVersion, callback) {
    ...
    return this.apiClient.callApi('/order/modify', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  placeOrder(body, apiVersion, callback) {
    ...
    return this.apiClient.callApi('/order/place', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
