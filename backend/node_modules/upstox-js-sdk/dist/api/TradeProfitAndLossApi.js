...
class TradeProfitAndLossApi {
  ...
  */
  ...
  getProfitAndLossCharges(segment, financialYear, apiVersion, opts, callback) {
    ...
    return this.apiClient.callApi('/trade/profit-loss/charges', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getTradeWiseProfitAndLossData(segment, financialYear, pageNumber, pageSize, apiVersion, opts, callback) {
    ...
    return this.apiClient.callApi('/trade/profit-loss/data', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getTradeWiseProfitAndLossMetaData(segment, financialYear, apiVersion, opts, callback) {
    ...
    return this.apiClient.callApi('/trade/profit-loss/metadata', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
