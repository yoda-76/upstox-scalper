...
class PortfolioApi {
  ...
  */
  ...
  convertPositions(body, apiVersion, callback) {
    ...
    return this.apiClient.callApi('/portfolio/convert-position', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getHoldings(apiVersion, callback) {
    ...
    return this.apiClient.callApi('/portfolio/long-term-holdings', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getPositions(apiVersion, callback) {
    ...
    return this.apiClient.callApi('/portfolio/short-term-positions', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
