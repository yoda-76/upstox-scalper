...
class UserApi {
  ...
  */
  ...
  getProfile(apiVersion, callback) {
    ...
    return this.apiClient.callApi('/user/profile', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
  /**
  ...
  getUserFundMargin(apiVersion, opts, callback) {
    ...
    return this.apiClient.callApi('/user/get-funds-and-margin', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
  }
}
